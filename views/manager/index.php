...
<div class="manager-index">
                                            ...
                                            <div class="main-page-right_block-body-line row">
                                                <div class="main-page-right_block-body-line-label col-xs-6">
                                                    <div class="main-page-right_block-body-line-label-name id-<?= $i ?>">
                                                        <input type="checkbox"
                                                               class="mainPage-rightBlock-body-Checkbox ch-<?= $i ?> cb-<?= $type ?>"
                                                               value="<?= $type ?>_<?= $row_key ?>"
                                                               name="<?= $type ?>_<?= $row_key ?>"
                                                    ...
                                                    <div class="main-page-right_block-body-line-label-comments">
                                                        <div>Среднее за период: <span
                                                                    class="av_<?= $type ?>_<?= $row_key ?>"><?= $row['for_day'] ?></span>
                                                        </div>
                                                        <div>Всего за 30 дней: <span
                                                                    class=""><?= $row['for30days'] ?></span></div>
                                                        <?php if ($type == 'money' && $row_key == 'summary') { ?>
                                                            <div>1я оплата: <span
                                                                        class="fv_summary_first_payment"><?= $row['first_payments'] ?></span>
                                                            </div>
                                                            <div>2я оплата: <span
                                                                        class="fv_summary_second_payment"><?= $row['second_payments'] ?></span>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                </div>
    ...
    <?php if ($user->hasRole(['manager-payment']) && !empty($manager)) { ?>
