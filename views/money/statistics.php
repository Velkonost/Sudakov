...
$this->title = 'Статистика по коллекциям';
...
<div class="manager-index">
    ...
    <h2>Статистика по коллекциям</h2>

    <?php if ($user->hasRole(['superadmin'])) { ?>
        <!-- Diagram-->
        <div class="row diagram-container" data-url="<?= Url::to(['money/diagram']) ?>">
            <div class="col-xs-12 col-sm-6 col-md-8">
                <div class="filters">
                    <div class="col-xs-6">  <div id="piechart_3d_count" style="width: 450px; height: 500px;"></div></div>

                    <div class="col-xs-6">  <div id="piechart_3d_summ" style="width: 450px; height: 500px;"></div></div>
                    <style>#piechart_3d_count div.google-visualization-tooltip {  border: none !important;box-shadow: none !important;min-width: 105px !important;max-width: 200px !important;min-height: 95px !important;position: relative !important; top:-100px !important;left:350px !important; z-index:9999;}
                        #piechart_3d_count div.google-visualization-tooltip p{margin:0 0 3px;}
                        #piechart_3d_summ div.google-visualization-tooltip {   border: none !important;box-shadow: none !important;min-width: 105px !important;max-width: 200px !important;min-height: 95px !important;position: relative !important; top:-100px !important;left:-32px !important; z-index:9999;}
                        .google-visualization-tooltip-square{height:1.5em !important;width:1.5em !important;}
                        #piechart_3d_summ div.google-visualization-tooltip p{margin:0 0 3px;}</style>
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="main-page-right_block-caption row">
                    ...
                    <div class="fact col-xs-2 caption">штук</div>
                    <div class="col-xs-2"></div>
                    <div class="plan col-xs-2 caption">деньги</div>
                </div>
                <!-- 1 block -->
                <form id="right_block_form" data-url="<?= Url::to(['money/get-stat-info']) ?>">
                    <?php $i = 0;
                                        ...
                                        <div class="main-page-right_block-body-line row">
                                            <div class="main-page-right_block-body-line-label col-xs-6">
                                                ...
                                                <div class="main-page-right_block-body-line-label-comments">
                                                    <div>Среднее за период: <span class="av_<?= $type ?>_<?= $i?>"><?= $row['for_day'] ?></span></div>
                                                    <div>Всего за 30 дней: <span class=""><?= $row['for30days'] ?></span></div>

                                                </div>
                                            </div>
                                            <div class="main-page-right_block-body-line-fact col-xs-2">
                                                <div class="fact-value fv_<?= $type ?>_<?= $i?>_count">
                                                    <?= $row['for30days'] ?>
                                                </div>
                                            <span class="main-page-right_block-body-line-fact-status fc_<?= $type ?>_<?= $i?>">
                                                <?= $row['fact']['change'] ?>
                                            </span>
                                            </div>
                                            <div class="main-page-right_block-body-line-percent ratio_<?= $type ?>_<?= $i?> col-xs-2"></div>
                                            <?php $i++; ?>
                                            <div class="main-page-right_block-body-line-plan col-xs-2 fv_<?= $type ?>_<?= $i?>_summ"><?= $row['plan'] ?></div>
